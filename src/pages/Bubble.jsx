            ...
            <div className='flex justify-between items-center mb-4'>
                ...
                {users.length > 0 && (
                    <div className='mt-4 max-w-md mx-auto'>
                        ...
                        <div className='space-y-1 max-h-40 overflow-x-auto flex items-center gap-2'>
                            {users
                                ...
                                .map((user, index) => {
                                    ...
                                    return (
                                        <div
                                            key={user.id}
                                            className={`flex justify-between items-center text-xs p-2 rounded transition-colors ${isCurrentUser ? 'bg-blue-700 border-l-4 border-red-500' : 'bg-gray-400'
                                                }`}
                                        >
            ...
            <div className='border max-w-[1400px] h-[600px] mx-auto w-full border-red-400 flex-1 rounded-xl relative overflow-hidden bg-gray-900'>
                {users.length > 0 && users.map((user) => {
                    ...
                    return (
                        <div
                            key={user.id}
                            className={`absolute flex flex-col items-center justify-center rounded-full border-2 text-xs font-medium transition-all duration-200 ${colorClass} ${isCurrentUser ? 'ring-2 ring-white ring-opacity-50' : ''
                                }`}
                            style={{
                                left: `${user.x}px`,
                                top: `${user.y}px`,
